    ...
    <div className="w-full relative bg-whitesmoke-400 overflow-hidden flex flex-col items-start justify-start text-center text-base text-gray-1400 font-inter">
      <div className="self-stretch rounded-3xl overflow-hidden flex flex-col items-center justify-start pt-[140px] px-[70px] pb-0 z-[0] text-left text-lg text-white">
        ...
        <div className="w-[1250px] relative h-[580px] text-sm text-dimgray">
          <div className="absolute top-[0px] left-[65.08px] w-[1119.8px] h-[580px]">
            <Image
              className="absolute top-[0px] left-[13.3px] w-[542.8px] h-[580px]"
              width={542.8}
              height={580}
              sizes="100vw"
              alt=""
              src="Rectangle 814.svg"
            />
            <Image
              className="absolute top-[0px] left-[556.09px] w-[542.8px] h-[580px] object-contain"
              width={542.8}
              height={580}
              sizes="100vw"
              alt=""
              src="Rectangle 815.svg"
            />
            <Image
              className="absolute top-[33.06px] left-[20.57px] w-[535.8px] h-[525.6px]"
              width={535.8}
              height={525.6}
              sizes="100vw"
              alt=""
              src="Group 2085663279.svg"
            />
            <Image
              className="absolute top-[33.06px] left-[558.23px] w-[535.8px] h-[525.6px] object-contain"
              width={535.8}
              height={525.6}
              sizes="100vw"
              alt=""
              src="Group 2085663280.png"
            />
            <div className="absolute top-[298.6px] left-[364.48px] rounded-[99px] w-[95.8px] h-[95.8px] overflow-hidden flex items-center justify-center">
              <Image
                className="w-full h-full overflow-hidden object-cover absolute left-[0px] top-[36px] [transform:scale(1.869)]"
                width={95.8}
                height={95.8}
                sizes="100vw"
                alt=""
                src="Frame 2147228063.png"
              />
            </div>
            <div className="absolute top-[171.9px] left-[262.27px] rounded-[99px] w-[101.8px] h-[101.8px] overflow-hidden flex items-center justify-center">
              <Image
                className="w-full h-full overflow-hidden object-cover absolute left-[0px] top-[36px] [transform:scale(1.759)]"
                width={101.8}
                height={101.8}
                sizes="100vw"
                alt=""
                src="Frame 2147228070.png"
              />
            </div>
            <div className="absolute top-[158.86px] left-[610.84px] rounded-[99px] w-[103.2px] h-[103.2px] overflow-hidden flex items-center justify-center">
              <Image
                className="w-full h-full object-cover absolute left-[6px] top-[22px] [transform:scale(1.434)]"
                width={103.2}
                height={103.2}
                sizes="100vw"
                alt=""
                src="Frame 2147228076.png"
              />
            </div>
            <div className="absolute top-[273.02px] left-[745.99px] rounded-[99px] w-[106.9px] h-[106.9px] overflow-hidden flex items-center justify-center">
              <Image
                className="w-full h-full object-cover absolute left-[0px] top-[15px] [transform:scale(1.347)]"
                width={106.9}
                height={106.9}
                sizes="100vw"
                alt=""
                src="Frame 2147228077.png"
              />
            </div>
            <div className="absolute top-[139.81px] left-[828.02px] rounded-[99px] w-[93.1px] h-[93.1px] overflow-hidden flex items-center justify-center">
              <Image
                className="w-full h-full object-cover absolute left-[0px] top-[22px] [transform:scale(1.547)]"
                width={93.1}
                height={93.1}
                sizes="100vw"
                alt=""
                src="Frame 2147228078.png"
              />
            </div>
            <div className="absolute top-[295.84px] left-[576.32px] rounded-[99px] w-[101.3px] h-[101.3px] overflow-hidden flex items-center justify-center">
              <Image
                className="w-full h-full object-cover absolute left-[0px] top-[22px] [transform:scale(1.422)]"
                width={101.3}
                height={101.3}
                sizes="100vw"
                alt=""
                src="Frame 2147228081.png"
              />
            </div>
            <div className="absolute top-[201.38px] left-[978.68px] rounded-[99px] w-[97.2px] h-[97.2px] overflow-hidden flex items-center justify-center">
              <Image
                className="w-full h-full object-cover absolute left-[0px] top-[18px] [transform:scale(1.482)]"
                width={97.2}
                height={97.2}
                sizes="100vw"
                alt=""
                src="Frame 2147228079.png"
              />
            </div>
            <div className="absolute top-[372.96px] left-[927.79px] rounded-[99px] w-[87px] h-[87px] overflow-hidden flex items-center justify-center">
              <Image
                className="w-full h-full object-cover absolute left-[2px] top-[22px] [transform:scale(1.696)]"
                width={87}
                height={87}
                sizes="100vw"
                alt=""
                src="Frame 2147228080.png"
              />
            </div>
            <div className="absolute top-[178.45px] left-[472.6px] rounded-[99px] w-[104px] h-[104px] overflow-hidden flex items-center justify-center">
              <Image
                className="w-full h-full overflow-hidden object-cover absolute left-[0px] top-[36px] [transform:scale(1.722)]"
                width={104}
                height={104}
                sizes="100vw"
                alt=""
                src="Frame 2147228068.png"
              />
            </div>
            <div className="absolute top-[86.67px] left-[97.75px] rounded-[99px] w-[98.7px] h-[98.7px] overflow-hidden flex items-center justify-center">
              <Image
                className="w-full h-full overflow-hidden object-cover absolute left-[0px] top-[36px] [transform:scale(1.815)]"
                width={98.7}
                height={98.7}
                sizes="100vw"
                alt=""
                src="Frame 2147228065.png"
              />
            </div>
            <div className="absolute top-[374.28px] left-[142.72px] rounded-[99px] w-[91.9px] h-[91.9px] overflow-hidden flex items-center justify-center">
              <Image
                className="w-full h-full overflow-hidden object-cover absolute left-[0px] top-[36px] [transform:scale(1.949)]"
                width={91.9}
                height={91.9}
                sizes="100vw"
                alt=""
                src="Frame 2147228067.png"
              />
            </div>
            <div className="absolute top-[234.66px] left-[812.45px] shadow-[0px_4.062992095947266px_2.71px_rgba(255,_255,_255,_0.36)_inset,_0px_1.3543307781219482px_1.35px_-0.68px_rgba(11,_32,_103,_0.05),_0px_0px_20.31px_-2.71px_rgba(0,_0,_0,_0.03)] [backdrop-filter:blur(17.3px)] rounded-[10.83px] bg-gray-1600 border-whitesmoke-300 border-solid border-[0.7px] box-border w-[230.7px] overflow-hidden flex flex-row items-center justify-start p-[8.1px] gap-[9.8px] text-center text-[10.83px] text-gray-300">
              <Image
                className="w-[37.2px] relative rounded-[60.68px] max-h-full overflow-hidden shrink-0 z-[0]"
                width={37.2}
                height={37.2}
                sizes="100vw"
                alt=""
                src="Frame 2147227914.svg"
              />
              <div className="flex flex-col items-start justify-start gap-[1.3px] z-[1]">
                <div className="relative tracking-[-0.01em] font-medium">Shopify</div>
                <div className="relative text-[9.48px] tracking-[-0.01em] font-medium text-gray-200">
                  New Subscriber - $39.99
                </div>
              </div>
              <div className="!!m-[0 important] absolute top-[0px] right-[-0.31px] overflow-hidden flex flex-row items-center justify-center p-[8.1px] z-[2] text-[8.13px] text-gray-200">
                <div className="relative tracking-[-0.01em]">1m ago</div>
              </div>
            </div>
            <div className="absolute top-[389.69px] left-[752.34px] shadow-[0px_38px_11px_rgba(0,_0,_0,_0),_0px_24px_10px_rgba(0,_0,_0,_0.01),_0px_14px_8px_rgba(0,_0,_0,_0.05),_0px_6px_6px_rgba(0,_0,_0,_0.09),_0px_2px_3px_rgba(0,_0,_0,_0.1)] rounded-xl bg-white border-whitesmoke-800 border-solid border-[0.6px] flex flex-row items-center justify-start py-1.5 px-3 gap-2">
              <div className="w-8 relative rounded-[99px] bg-aliceblue-200 h-8 overflow-hidden shrink-0">
                <div className="absolute top-[calc(50%_-_9px)] left-[calc(50%_-_9px)] bg-gray-1500 w-[18px] h-[18px] overflow-hidden">
                  <Image
                    className="absolute h-[83.33%] w-full top-[8.33%] right-[12.5%] bottom-[8.33%] left-[12.5%] max-w-full overflow-hidden max-h-full"
                    width={13.5}
                    height={15}
                    sizes="100vw"
                    alt=""
            ...
            <div className="absolute top-[214.69px] left-[0px] shadow-[0px_38px_11px_rgba(0,_0,_0,_0),_0px_24px_10px_rgba(0,_0,_0,_0.01),_0px_14px_8px_rgba(0,_0,_0,_0.05),_0px_6px_6px_rgba(0,_0,_0,_0.09),_0px_2px_3px_rgba(0,_0,_0,_0.1)] rounded-xl bg-white border-whitesmoke-800 border-solid border-[0.6px] flex flex-row items-center justify-start py-1.5 px-3 gap-2">
              <div className="w-8 relative rounded-[99px] bg-aliceblue-200 h-8 overflow-hidden shrink-0">
                <div className="absolute top-[calc(50%_-_9px)] left-[calc(50%_-_9px)] bg-gray-1500 w-[18px] h-[18px] overflow-hidden">
                  <Image
                    className="absolute h-[83.33%] w-full top-[8.33%] right-[12.5%] bottom-[8.33%] left-[12.5%] max-w-full overflow-hidden max-h-full"
            ...
            <div className="absolute top-[295.75px] left-[200.41px] shadow-[0px_38px_11px_rgba(0,_0,_0,_0),_0px_24px_10px_rgba(0,_0,_0,_0.01),_0px_14px_8px_rgba(0,_0,_0,_0.05),_0px_6px_6px_rgba(0,_0,_0,_0.09),_0px_2px_3px_rgba(0,_0,_0,_0.1)] rounded-xl bg-white border-whitesmoke-800 border-solid border-[0.6px] flex flex-row items-center justify-start py-1.5 px-3 gap-2">
              <div className="w-8 relative rounded-[99px] bg-aliceblue-200 h-8 overflow-hidden shrink-0">
                <div className="absolute top-[calc(50%_-_9px)] left-[calc(50%_-_9px)] bg-gray-1500 w-[18px] h-[18px] overflow-hidden">
                  <Image
                    className="absolute h-[83.33%] w-full top-[8.33%] right-[12.5%] bottom-[8.33%] left-[12.5%] max-w-full overflow-hidden max-h-full"
            ...
            <div className="absolute top-[127.9px] left-[950.84px] shadow-[0px_38px_11px_rgba(0,_0,_0,_0),_0px_24px_10px_rgba(0,_0,_0,_0.01),_0px_14px_8px_rgba(0,_0,_0,_0.05),_0px_6px_6px_rgba(0,_0,_0,_0.09),_0px_2px_3px_rgba(0,_0,_0,_0.1)] rounded-xl bg-white border-whitesmoke-800 border-solid border-[0.6px] flex flex-row items-center justify-start py-1.5 px-3 gap-2">
              <div className="w-8 relative rounded-[99px] bg-aliceblue-200 h-8 overflow-hidden shrink-0">
                <div className="absolute top-[calc(50%_-_9px)] left-[calc(50%_-_9px)] bg-gray-1500 w-[18px] h-[18px] overflow-hidden">
                  <Image
                    className="absolute h-[83.33%] w-full top-[8.33%] right-[12.5%] bottom-[8.33%] left-[12.5%] max-w-full overflow-hidden max-h-full"
            ...
            <Image
              className="absolute top-[0px] left-[13.3px] w-[1085.6px] h-[580px] object-cover"
              width={1085.6}
              height={580}
              sizes="100vw"
              alt=""
              src="Mask group.png"
            />
            <div className="absolute top-[113.78px] left-[calc(50%_-_13.56px)] shadow-[0px_243px_68px_rgba(0,_0,_0,_0),_0px_155px_62px_rgba(0,_0,_0,_0.01),_0px_87px_52px_rgba(0,_0,_0,_0.05),_0px_39px_39px_rgba(0,_0,_0,_0.09),_0px_10px_21px_rgba(0,_0,_0,_0.1)] rounded-[99px] [background:linear-gradient(171.91deg,_#12b2f9,_#514dfa)] w-5 h-[352.4px]" />
          </div>
        </div>
      </div>
      <div className="w-[1280px] !!m-[0 important] absolute top-[24px] left-[calc(50%_-_640px)] rounded-2xl flex flex-row items-center justify-between gap-0 z-[1] text-left text-lg text-gray-200 font-plus-jakarta-sans">
        <Image
        ...
        <div className="w-[1200px] relative rounded-2xl h-[138px] overflow-hidden shrink-0">
          ...
          <div className="absolute top-[58px] left-[-627px] flex flex-row items-center justify-start gap-[100px]">
            ...
            <Image
              ...
              sizes="100vw"
              alt=""
              src="Logo Alternative.svg.svg"
            />
            <Image
              className="w-[276.9px] relative h-9 overflow-hidden shrink-0"
              width={276.9}
              height={36}
              sizes="100vw"
              alt=""
              src="checkoutcom_logo.svg.svg"
            />
            <Image
              className="w-[275.6px] relative h-[70px] overflow-hidden shrink-0"
              width={275.6}
              height={70}
              sizes="100vw"
              alt=""
              src="bigcommerce_logo.svg.svg"
            />
          </div>
              ...
              <div className="self-stretch flex-1 overflow-hidden flex flex-col items-start justify-start py-3.5 px-6 text-center text-base font-inter">
                <div className="self-stretch flex flex-col items-end justify-start gap-2">
                  <div className="self-stretch shadow-[0px_6px_4px_rgba(255,_255,_255,_0.36)_inset,_0px_2px_2px_-1px_rgba(11,_32,_103,_0.05),_0px_0px_30px_-4px_rgba(0,_0,_0,_0.03)] rounded-2xl bg-gray-1600 border-whitesmoke-300 border-solid border-[1px] overflow-hidden flex flex-row items-center justify-start p-3 relative gap-[14.5px]">
                    <Image
                      className="w-[55px] relative rounded-[89.62px] max-h-full overflow-hidden shrink-0 z-[0]"
                      width={55}
                      height={55}
                      sizes="100vw"
                      alt=""
              ...
              <div className="w-[386.7px] relative bg-gray-100 h-[297px] overflow-hidden shrink-0 text-center text-[10px] text-gray-200">
                ...
                <div className="absolute top-[17px] left-[calc(50%_-_165.02px)] h-[237px] flex flex-row items-end justify-center gap-1.5 text-gray-1300">
                  <div className="w-[50px] flex flex-col items-start justify-start gap-0.5">
                    ...
                    <Image
                      className="self-stretch relative rounded-t-lg rounded-b-none max-w-full overflow-hidden h-[104px] shrink-0 object-cover"
                      width={50}
                      height={104}
                      sizes="100vw"
                      alt=""
                      src="Frame 2147228157.png"
                    />
                  </div>
                  <div className="w-[50px] flex flex-col items-start justify-start gap-0.5">
                    <div className="self-stretch shadow-[0px_0px_4px_2px_rgba(255,_255,_255,_0.24)_inset] rounded-lg bg-darkslategray-200 border-aliceblue-400 border-solid border-[0.6px] box-border h-[26px] overflow-hidden shrink-0 flex flex-row items-center justify-center">
                    ...
                    <Image
                      className="self-stretch relative rounded-t-lg rounded-b-none max-w-full overflow-hidden h-[75px] shrink-0 object-cover"
                      width={50}
                      height={75}
                      sizes="100vw"
                      alt=""
                  ...
                  <div className="w-[50px] flex flex-col items-start justify-start gap-0.5">
                    ...
                    <Image
                      className="self-stretch relative rounded-t-lg rounded-b-none max-w-full overflow-hidden h-[103px] shrink-0 object-cover"
                      width={50}
                      height={103}
                      sizes="100vw"
                      alt=""
                  ...
                  <div className="w-[50px] flex flex-col items-start justify-start gap-0.5">
                    ...
                    <Image
                      className="self-stretch relative rounded-t-lg rounded-b-none max-w-full overflow-hidden h-[134px] shrink-0 object-cover"
                      width={50}
                      height={134}
                      sizes="100vw"
                      alt=""
                  ...
                  <div className="w-[50px] flex flex-col items-start justify-start gap-1">
                    ...
                    <Image
                      className="self-stretch relative rounded-t-lg rounded-b-none max-w-full overflow-hidden h-[164px] shrink-0 object-cover"
                      width={50}
                      height={164}
                      sizes="100vw"
                      alt=""
                  ...
                  <div className="w-[50px] flex flex-col items-start justify-start gap-1">
                    ...
                    <Image
                      className="self-stretch relative rounded-t-lg rounded-b-none max-w-full overflow-hidden h-[207px] shrink-0 object-cover"
                      width={50}
                      height={207}
                      sizes="100vw"
                      alt=""
                ...
                <Image
                  className="absolute top-[253.83px] left-[-16.53px] max-h-full w-[408.5px]"
                  width={408.5}
                  height={1}
                  sizes="100vw"
                  alt=""
                  src="Vector 1194223292.svg"
                />
        ...
        <div className="w-[1280px] flex flex-col items-center justify-start py-20 px-0 box-border gap-[60px]">
          ...
          <div className="self-stretch flex flex-row items-center justify-start gap-5 text-left text-sm text-gray-300">
            <div className="flex-1 flex flex-col items-start justify-start gap-5 text-dimgray">
              <div className="self-stretch rounded-2xl bg-white border-white border-solid border-[0.8px] box-border h-[460px] overflow-hidden shrink-0 flex flex-col items-start justify-end">
                <div className="self-stretch flex-1 relative overflow-hidden">
                  <Image
                    className="absolute top-[-11px] left-[calc(50%_-_226.15px)] w-[453px] h-[219.2px]"
                    width={453}
                    height={219.2}
                    sizes="100vw"
                    alt=""
                    src="Rectangle 804.svg"
                  />
                  <div className="absolute top-[-33.26px] left-[-23.64px] w-[435.9px] h-[257px]">
                    <Image
                      className="absolute top-[0px] left-[0px] w-[217.9px] h-[257px]"
                      width={217.9}
                      height={257}
                      sizes="100vw"
                      alt=""
                      src="Group 2085663263.svg"
                    />
                    <div className="absolute top-[0px] left-[218px] w-[217.9px] h-[257px] overflow-hidden flex items-center justify-center">
                      <Image
                        className="w-full h-full object-cover absolute left-[0px] top-[17px] [transform:scale(1)]"
                        width={217.9}
                        height={257}
                        sizes="100vw"
                        alt=""
                        src="Group 2085663264.png"
                      />
                    </div>
                  </div>
                  <div className="absolute top-[calc(50%_-_26.5px)] left-[calc(50%_-_39.65px)] [filter:blur(30px)] rounded-[80.82px] [background:linear-gradient(162.75deg,_#12b2f9,_#514dfa)] w-20 h-20 overflow-hidden opacity-[0.3]" />
                  <div className="absolute top-[calc(50%_-_26.5px)] left-[calc(50%_-_39.65px)] rounded-[80.82px] w-20 h-20 overflow-hidden flex items-center justify-center">
                    <Image
                      className="w-full h-full overflow-hidden object-cover absolute left-[2px] top-[28px] [transform:scale(1.425)]"
                      width={80}
                      height={80}
                      sizes="100vw"
                      alt=""
                      src="Frame 2147228007.svg"
                    />
                  </div>
                  <div className="absolute top-[243.23px] left-[21.25px] w-[347.5px] h-[67.5px]">
                    <div className="absolute top-[23.5px] left-[0px] rounded-xl bg-white border-whitesmoke-800 border-solid border-[0.6px] flex flex-row items-center justify-start py-1.5 px-3 gap-2 opacity-[0.4]">
                      <div className="w-8 relative rounded-[99px] bg-aliceblue-200 h-8 overflow-hidden shrink-0">
                        <div className="absolute top-[calc(50%_-_9px)] left-[calc(50%_-_9px)] bg-gray-1500 w-[18px] h-[18px] overflow-hidden">
                          <Image
                            className="absolute h-[83.33%] w-full top-[8.33%] right-[12.5%] bottom-[8.33%] left-[12.5%] max-w-full overflow-hidden max-h-full"
                    ...
                    <div className="absolute top-[23.5px] left-[178.5px] rounded-xl bg-white border-whitesmoke-800 border-solid border-[0.6px] flex flex-row items-center justify-start py-1.5 px-3 gap-2 opacity-[0.4]">
                      <div className="w-8 relative rounded-[99px] bg-aliceblue-200 h-8 overflow-hidden shrink-0">
                        <div className="absolute top-[calc(50%_-_9px)] left-[calc(50%_-_9px)] bg-gray-1500 w-[18px] h-[18px] overflow-hidden">
                          <Image
                            className="absolute h-[83.33%] w-full top-[8.33%] right-[12.5%] bottom-[8.33%] left-[12.5%] max-w-full overflow-hidden max-h-full"
                    ...
                    <div className="absolute top-[0px] left-[89.25px] shadow-[0px_38px_11px_rgba(0,_0,_0,_0),_0px_24px_10px_rgba(0,_0,_0,_0.01),_0px_14px_8px_rgba(0,_0,_0,_0.05),_0px_6px_6px_rgba(0,_0,_0,_0.09),_0px_2px_3px_rgba(0,_0,_0,_0.1)] rounded-xl bg-white border-whitesmoke-800 border-solid border-[0.6px] flex flex-row items-center justify-start py-1.5 px-3 gap-2">
                      <div className="w-8 relative rounded-[99px] bg-aliceblue-200 h-8 overflow-hidden shrink-0">
                        <div className="absolute top-[calc(50%_-_9px)] left-[calc(50%_-_9px)] bg-gray-1500 w-[18px] h-[18px] overflow-hidden">
                          <Image
                            className="absolute h-[83.33%] w-full top-[8.33%] right-[12.5%] bottom-[8.33%] left-[12.5%] max-w-full overflow-hidden max-h-full"
                  ...
                  <Image
                    className="absolute top-[76.6px] left-[calc(50%_-_21.61px)] rounded-[99px] w-11 h-11 overflow-hidden object-cover"
                    width={44}
                    height={44}
                    sizes="100vw"
                    alt=""
                    src="Frame 2147227999.png"
                  />
                  <Image
                    className="absolute top-[31.5px] left-[calc(50%_-_83.65px)] rounded-[99px] w-11 h-11 overflow-hidden object-cover"
                    width={44}
                    height={44}
                    sizes="100vw"
                    alt=""
                    src="Frame 2147228000.png"
                  />
                  <Image
                    className="absolute top-[-29px] left-[calc(50%_-_63.15px)] rounded-[99px] w-11 h-11 overflow-hidden object-cover"
                    width={44}
                    height={44}
                    sizes="100vw"
                    alt=""
                    src="Frame 2147228004.png"
                  />
                  <Image
                    className="absolute top-[-12.5px] left-[calc(50%_-_154px)] rounded-[99px] w-11 h-11 overflow-hidden object-cover"
                    width={44}
                    height={44}
                    sizes="100vw"
                    alt=""
                    src="Frame 2147228005.png"
                  />
                  <Image
                    className="absolute top-[0px] left-[calc(50%_+_8.47px)] rounded-[99px] w-11 h-11 overflow-hidden object-cover"
                    width={44}
                    height={44}
                    sizes="100vw"
                    alt=""
                    src="Frame 2147228001.png"
                  />
                  <Image
                    className="absolute top-[51px] left-[calc(50%_+_45.6px)] rounded-[99px] w-11 h-11 overflow-hidden object-cover"
                    width={44}
                    height={44}
                    sizes="100vw"
                    alt=""
                    src="Frame 2147228002.png"
                  />
                  <Image
                    className="absolute top-[-6.23px] left-[calc(50%_+_97.31px)] rounded-[99px] w-11 h-11 overflow-hidden object-cover"
                    width={44}
                    height={44}
                    sizes="100vw"
                    alt=""
                    src="Frame 2147228006.png"
                  />
                </div>
              ...
              <div className="self-stretch rounded-2xl bg-white h-[460px] overflow-hidden shrink-0 flex flex-col items-center justify-end text-darkslategray-100">
                ...
                <div className="self-stretch flex-1 relative overflow-hidden">
                  ...
                  />
                  <Image
                    className="absolute top-[calc(50%_-_251.42px)] left-[calc(50%_-_250.57px)] w-[501.8px] h-[501.8px]"
                    width={501.8}
                    height={501.8}
                    sizes="100vw"
                    alt=""
                    src="Group 2085663268.svg"
                  />
                  <div className="absolute top-[calc(50%_-_130.5px)] left-[calc(50%_-_119.65px)] shadow-[0px_8px_20px_-8px_rgba(34,_68,_113,_0.25),_0px_12px_14px_-3px_rgba(29,_36,_51,_0.08),_0px_2px_2px_rgba(29,_36,_51,_0.08)] rounded-xl bg-white border-whitesmoke-500 border-solid border-[1px] box-border w-60 overflow-hidden flex flex-col items-start justify-start py-[15px] px-[11px] gap-6">
                    <div className="self-stretch flex flex-col items-start justify-start gap-4">
                      ...
                      <Image
                        className="w-[212.1px] relative max-h-full"
                        width={212.1}
                        height={1}
                        sizes="100vw"
                        alt=""
                  ...
                  <div className="absolute top-[-104.83px] left-[-97.17px] w-[553.3px] h-[498.9px] overflow-hidden flex items-center justify-center">
                    <Image
                      className="w-full h-full object-cover absolute left-[0px] top-[0px] [transform:scale(1.181)]"
                      width={553.3}
                      height={498.9}
                      sizes="100vw"
                      alt=""
            ...
            <div className="flex-1 flex flex-col items-start justify-start gap-5">
              ...
              <div className="self-stretch rounded-3xl bg-white h-[300px] overflow-hidden shrink-0 flex flex-col items-center justify-end text-xl">
                <div className="self-stretch flex-1 relative overflow-hidden">
                  <Image
                    className="absolute top-[calc(50%_-_195px)] left-[calc(50%_-_194.65px)] w-[390px] h-[390px]"
                    width={390}
                    height={390}
                    sizes="100vw"
                    alt=""
                  ...
                  />
                  <Image
                    className="absolute top-[22.85px] left-[62.27px] w-[280.8px] h-[154.5px] hidden opacity-[0.25]"
                    width={280.8}
                    height={154.5}
                    sizes="100vw"
                    alt=""
                    src="Vector.svg"
                  />
                  <div className="absolute top-[20.6px] left-[calc(50%_-_123.23px)] w-[247.2px] h-[155.8px]">
                    <div className="absolute top-[102.01px] left-[calc(50%_-_94.56px)] rounded-[11.94px] bg-white border-whitesmoke-800 border-solid border-[0.6px] box-border w-[189.1px] overflow-hidden flex flex-row items-center justify-start py-2 px-[11.9px] gap-2">
                      <div className="w-[37.8px] relative rounded-[116.99px] bg-whitesmoke-200 h-[37.8px] overflow-hidden shrink-0">
                        <div className="absolute top-[calc(50%_-_11.81px)] left-[calc(50%_-_11.81px)] bg-gray-1500 w-[23.6px] h-[23.6px] overflow-hidden">
                          <Image
                            className="absolute h-[91.95%] w-full top-[4.17%] right-[3.88%] bottom-[3.88%] left-[4.17%] max-w-full overflow-hidden max-h-full"
                            width={21.7}
                            height={21.7}
                            sizes="100vw"
                            alt=""
                      ...
                      <div className="flex flex-col items-start justify-start gap-1">
                        <div className="w-[116.1px] relative rounded-[98.52px] bg-whitesmoke-200 h-1.5" />
                        <div className="w-[70.6px] relative rounded-[98.52px] bg-whitesmoke-200 h-1.5" />
                      </div>
                    </div>
                    <div className="absolute top-[0px] left-[calc(50%_-_94.56px)] rounded-[11.94px] bg-white border-whitesmoke-800 border-solid border-[0.6px] box-border w-[189.1px] overflow-hidden flex flex-row items-center justify-start py-2 px-[11.9px] gap-2">
                      <div className="w-[37.8px] relative rounded-[116.99px] bg-whitesmoke-200 h-[37.8px] overflow-hidden shrink-0">
                        <div className="absolute top-[calc(50%_-_11.81px)] left-[calc(50%_-_11.81px)] bg-gray-1500 w-[23.6px] h-[23.6px] overflow-hidden">
                          <Image
                            className="absolute h-[91.95%] w-full top-[4.17%] right-[3.88%] bottom-[3.88%] left-[4.17%] max-w-full overflow-hidden max-h-full"
                    ...
                    <div className="absolute top-[12.35px] left-[calc(50%_-_104.81px)] shadow-[0px_15.48044490814209px_8.85px_rgba(0,_0,_0,_0.05),_0px_2.2114920616149902px_3.32px_rgba(0,_0,_0,_0.1)] rounded-[13.27px] bg-white w-[210.1px] overflow-hidden flex flex-row items-center justify-start py-[8.8px] px-[13.3px] box-border gap-[8.8px]">
                      <div className="w-[42px] relative rounded-[129.99px] bg-lightcyan h-[42px] overflow-hidden shrink-0">
                        <div className="absolute top-[calc(50%_-_13.12px)] left-[calc(50%_-_13.12px)] bg-gray-1500 w-[26.3px] h-[26.3px] overflow-hidden">
                          <Image
                            className="absolute h-[91.63%] w-full top-[4.16%] right-[4.2%] bottom-[4.2%] left-[4.16%] max-w-full overflow-hidden max-h-full"
                            width={24.1}
                            height={24.1}
                            sizes="100vw"
                            alt=""
                      ...
                      <div className="flex flex-col items-start justify-start gap-[4.4px]">
                        <div className="w-[129px] relative rounded-[109.47px] bg-whitesmoke-200 h-[6.6px]" />
                        <div className="w-[78.4px] relative rounded-[109.47px] bg-whitesmoke-200 h-[6.6px]" />
                      </div>
                    </div>
                    <div className="absolute top-[82.06px] left-[calc(50%_-_104.81px)] shadow-[0px_15.48044490814209px_8.85px_rgba(0,_0,_0,_0.05),_0px_2.2114920616149902px_3.32px_rgba(0,_0,_0,_0.1)] rounded-[13.27px] bg-white w-[210.1px] overflow-hidden flex flex-row items-center justify-start py-[8.8px] px-[13.3px] box-border gap-[8.8px]">
                      <div className="w-[42px] relative rounded-[129.99px] bg-lightcyan h-[42px] overflow-hidden shrink-0">
                        <div className="absolute top-[calc(50%_-_13.12px)] left-[calc(50%_-_13.12px)] bg-gray-1500 w-[26.3px] h-[26.3px] overflow-hidden">
                          <Image
                            className="absolute h-[91.63%] w-full top-[4.16%] right-[4.2%] bottom-[4.2%] left-[4.16%] max-w-full overflow-hidden max-h-full"
                    ...
                    <div className="absolute top-[44.78px] left-[calc(50%_-_123.6px)] shadow-[0px_49.433349609375px_14.31px_rgba(0,_0,_0,_0),_0px_31.2210636138916px_13.01px_rgba(0,_0,_0,_0.01),_0px_18.2122859954834px_10.41px_rgba(0,_0,_0,_0.05),_0px_7.8052659034729px_7.81px_rgba(0,_0,_0,_0.09),_0px_2.601755142211914px_3.9px_rgba(0,_0,_0,_0.1)] rounded-[15.61px] bg-white w-[247.2px] overflow-hidden flex flex-row items-center justify-start py-[10.4px] px-[15.6px] box-border gap-[10.4px]">
                      <div className="w-[49.4px] relative rounded-[152.93px] bg-lightcyan h-[49.4px] overflow-hidden shrink-0">
                        <div className="absolute top-[9.11px] left-[calc(50%_-_14.94px)] bg-gray-1500 w-[29.9px] h-[29.9px] overflow-hidden">
                          <Image
                            className="absolute h-[91.64%] w-full top-[4.17%] right-[4.19%] bottom-[4.19%] left-[4.17%] max-w-full overflow-hidden max-h-full"
                            width={27.4}
                            height={27.4}
                            sizes="100vw"
                            alt=""
                      ...
                      <div className="flex flex-col items-start justify-start gap-[5.2px]">
                        <div className="w-[151.7px] relative rounded-[128.79px] bg-whitesmoke-200 h-[7.8px]" />
                        <div className="w-[92.3px] relative rounded-[128.79px] bg-whitesmoke-200 h-[7.8px]" />
                      </div>
                    </div>
                  </div>
                  <div className="absolute top-[-74.32px] left-[-101.12px] w-[553.3px] h-[355.7px] overflow-hidden flex items-center justify-center">
                    <Image
                      className="w-full h-full object-cover absolute left-[0px] top-[0px] [transform:scale(1.181)]"
                      width={553.3}
                      height={355.7}
            ...
            <div className="flex-1 flex flex-col items-end justify-start gap-5 text-xs">
              <div className="self-stretch rounded-2xl bg-white h-[460px] overflow-hidden shrink-0 flex flex-col items-center justify-end">
                <div className="self-stretch flex-1 relative overflow-hidden">
                  <div className="absolute top-[-63.16px] left-[1.37px] bg-whitesmoke-100 w-[412px] h-[441.3px]" />
                  <div className="absolute top-[-33px] left-[calc(50%_-_109.65px)] w-[220px] flex flex-col items-start justify-center gap-2">
                    <div className="self-stretch rounded-lg bg-white border-whitesmoke-300 border-solid border-[1px] flex flex-row items-center justify-start p-2 gap-2">
                      <div className="w-9 relative rounded-[93.79px] bg-lavenderblush h-9 overflow-hidden shrink-0">
                        <div className="absolute top-[calc(50%_-_10.42px)] left-[calc(50%_-_10.42px)] bg-gray-1500 w-[20.8px] h-[20.8px] overflow-hidden">
                          <Image
                            className="absolute h-[91.83%] w-full top-[4.18%] right-[4%] bottom-[4%] left-[4.17%] max-w-full overflow-hidden max-h-full"
                            width={19.1}
                            height={19.1}
                            sizes="100vw"
                            alt=""
                      ...
                      <div className="flex flex-col items-start justify-start">
                        ...
                        <div className="self-stretch relative text-[10px] tracking-[-0.01em] leading-[140%] text-gray-200">
                          $75.20
                        </div>
                      </div>
                    </div>
                    <div className="self-stretch rounded-lg bg-white border-whitesmoke-300 border-solid border-[1px] flex flex-row items-center justify-start p-2 gap-2">
                      <div className="w-9 relative rounded-[99px] bg-lavenderblush h-9 overflow-hidden shrink-0">
                        <div className="absolute top-[calc(50%_-_10.42px)] left-[calc(50%_-_10.42px)] bg-gray-1500 w-[20.8px] h-[20.8px] overflow-hidden">
                          <Image
                            className="absolute h-[91.83%] w-full top-[4.18%] right-[4%] bottom-[4%] left-[4.17%] max-w-full overflow-hidden max-h-full"
                            width={19.1}
                  ...
                  <div className="absolute top-[154.5px] left-[calc(50%_-_109.65px)] w-[220px] flex flex-col items-start justify-center gap-2">
                    <div className="self-stretch rounded-lg bg-white border-whitesmoke-800 border-solid border-[1px] overflow-hidden flex flex-row items-center justify-start p-2 gap-2">
                      <div className="w-9 relative rounded-[93.79px] bg-mintcream h-9 overflow-hidden shrink-0">
                        <div className="absolute top-[calc(50%_-_10.42px)] left-[calc(50%_-_10.42px)] bg-gray-1500 w-[20.8px] h-[20.8px] overflow-hidden">
                          <Image
                            className="absolute h-[91.83%] w-full top-[4.18%] right-[4%] bottom-[4%] left-[4.17%] max-w-full overflow-hidden max-h-full"
                            width={19.1}
                      ...
                      <div className="flex flex-col items-start justify-start">
                        <div className="relative tracking-[-0.01em] leading-[140%] font-medium">{`Payment Successful `}</div>
                        <div className="self-stretch relative text-[10px] tracking-[-0.01em] leading-[140%] text-gray-200">
                          $99.59
                        </div>
                      </div>
                  ...
                  <Image
                    className="absolute top-[-112.35px] left-[-9.03px] w-[430px] h-[559.7px] object-cover"
                    width={430}
                    height={559.7}
                    sizes="100vw"
                    alt=""
                    src="Group 2085663272.png"
                  />
                  <div className="absolute top-[-275.2px] left-[-93.24px] w-[554.9px] h-[329.7px] overflow-hidden flex items-center justify-center">
                    <Image
                      className="w-full h-full object-cover absolute left-[0px] top-[0px] [transform:scale(1.108)]"
                      width={554.9}
                      height={329.7}
                      sizes="100vw"
                      alt=""
                  ...
                  <div className="absolute top-[612.2px] left-[-108.52px] w-[554.9px] h-[329.7px] overflow-hidden flex items-center justify-center">
                    <Image
                      className="w-full h-full object-cover absolute left-[0px] top-[0px] [transform:scale(1.108)]"
                      width={554.9}
                      height={329.7}
                  ...
                  <Image
                    className="absolute top-[calc(50%_-_20.5px)] left-[calc(50%_-_63.89px)] w-[128.5px] h-10 overflow-hidden object-cover"
                    width={128.5}
                    height={40}
                    sizes="100vw"
                    alt=""
              ...
              <div className="self-stretch relative rounded-3xl bg-white h-[460px] overflow-hidden shrink-0 text-base">
                <div className="absolute bottom-[0px] left-[0px] w-[390px] flex flex-col items-start justify-start p-5 box-border gap-4">
                  ...
                  <div className="w-[191px] relative shadow-[0px_14px_14px_rgba(0,_0,_0,_0.17),_0px_4px_8px_rgba(0,_0,_0,_0.2)] h-[50px] text-white">
                    <div className="absolute top-[0px] left-[0px] shadow-[0px_0px_8px_4px_rgba(255,_255,_255,_0.16)_inset,_0px_-2px_0px_#000_inset,_0px_1px_1px_#000_inset,_0px_2px_1px_rgba(255,_255,_255,_0.25)_inset] rounded-[20px] [background:linear-gradient(88.67deg,_#1d1d1d,_#333_34.6%,_#3d3d3d_76.69%,_#1d1d1d)] h-[50px] overflow-hidden flex flex-row items-center justify-center py-3 px-6 box-border">
                      <div className="shadow-[0px_2px_2px_rgba(0,_0,_0,_0.48)] flex flex-row items-center justify-start gap-3">
                ...
                <div className="absolute top-[-322.46px] left-[-185.79px] w-[659.9px] h-[525.2px] overflow-hidden flex items-center justify-center">
                  <Image
                    className="w-full h-full object-cover absolute left-[0px] top-[46px] [transform:scale(1)]"
                    width={659.9}
                    height={525.2}
                    sizes="100vw"
                    alt=""
                    src="Group 2085663289.svg"
                  />
                </div>
            ...
            <div className="w-[980px] rounded-[20px] bg-white overflow-hidden flex flex-row items-end justify-center p-4 box-border gap-4">
              ...
              <div className="w-[200px] rounded-2xl [background:linear-gradient(178.19deg,_#12b2f9,_#514dfa)] overflow-hidden shrink-0 flex flex-col items-start justify-start">
                <div className="self-stretch border-gray-1000 border-solid border-b-[1px] box-border h-[60px] overflow-hidden shrink-0 flex flex-row items-center justify-center py-4 px-6">
                  <Image
                    className="w-full relative h-6 overflow-hidden shrink-0 object-cover"
                    width={77.1}
                    height={24}
                    sizes="100vw"
                    alt=""
                ...
                <div className="self-stretch border-gray-1000 border-solid border-b-[1px] box-border h-[60px] overflow-hidden shrink-0 flex flex-row items-center justify-center py-4 px-6">
                  <div className="w-6 relative h-6">
                    <div className="absolute top-[0px] left-[0px] shadow-[0px_2px_3px_rgba(0,_0,_0,_0.12),_0px_5px_8px_rgba(0,_0,_0,_0.14),_0px_10px_20px_rgba(0,_0,_0,_0.08)] bg-gray-1500 w-6 h-6">
                      <Image
                    ...
                    <Image
                      className="absolute top-[calc(50%_-_17px)] left-[calc(50%_-_17px)] w-[34px] h-[34px]"
                      width={34}
                      height={34}
                      sizes="100vw"
                      alt=""
          ...
          <div className="w-[980px] overflow-hidden flex flex-row items-start justify-center flex-wrap content-start gap-3 text-blueviolet">
            <div className="rounded-xl bg-white border-gainsboro-300 border-solid border-[1px] flex flex-row items-center justify-center py-2 px-3 gap-2">
              <Image
                ...
                sizes="100vw"
                alt=""
                src="Credit card, Checkmark, Done, Check, Certificate.svg"
              />
            ...
            <div className="rounded-xl bg-white border-gainsboro-300 border-solid border-[1px] flex flex-row items-center justify-center py-2 px-3 gap-2 text-chocolate">
              <Image
                ...
                sizes="100vw"
                alt=""
                src="package-box-update-loading.svg"
              />
            ...
            <div className="rounded-xl bg-white border-gainsboro-300 border-solid border-[1px] flex flex-row items-center justify-center py-2 px-3 gap-2 text-crimson">
              <Image
                ...
                sizes="100vw"
                alt=""
                src="Interaction, Teamwork, Group.svg"
              />
              <div className="relative tracking-[-0.04em] leading-[150%] font-medium">
                Team activity log
              </div>
            ...
            <div className="rounded-xl bg-white border-gainsboro-300 border-solid border-[1px] flex flex-row items-center justify-center py-2 px-3 gap-2 text-olivedrab">
              <Image
                ...
                sizes="100vw"
                alt=""
                src="Travel, Earth, World, Direction.svg"
              />
              ...
              <div className="self-stretch rounded-2xl bg-whitesmoke-400 border-gainsboro-200 border-solid border-[1px] box-border h-[380px] overflow-hidden shrink-0 flex flex-row items-center justify-start">
                <div className="self-stretch flex-[0.8156] overflow-hidden flex flex-col items-start justify-end py-6 px-10 relative gap-4">
                  ...
                  <div className="self-stretch relative text-base tracking-[-0.01em] leading-[150%] text-gray-200 z-[2]">
                    ...
                    intelligent upsells that turn onetime buyers into repeat customers with Apptics
                  </div>
                  <div className="!!m-[0 important] absolute top-[19.96px] left-[40px] flex flex-row items-center justify-center py-2 px-0 z-[3] text-[90px] text-gray-100">
                    <b className="relative tracking-[-0.06em] leading-[150%] [text-shadow:0px_4px_8px_rgba(0,_0,_0,_0.03),_0px_1.5268816947937012px_1.53px_rgba(0,_0,_0,_0.06)]">
                      03
        ...
        <div className="w-[1200px] flex flex-col items-center justify-start py-20 px-0 box-border gap-[60px]">
          ...
          <div className="shadow-[0px_0px_8px_4px_rgba(255,_255,_255,_0.69)_inset,_0px_0px_24px_8px_rgba(255,_255,_255,_0.8)_inset] rounded-[32px] bg-white border-white border-solid border-[1px] overflow-hidden flex flex-col items-start justify-start p-5 relative gap-2.5 text-left text-xl text-gray-300 font-plus-jakarta-sans">
            ...
            <div className="w-[1020px] shadow-[0px_8px_10px_-4px_rgba(0,_0,_0,_0.08),_0px_0px_12px_5px_rgba(255,_255,_255,_0.5)_inset] rounded-[20px] bg-white border-aliceblue-300 border-solid border-[1px] box-border h-[126px] overflow-hidden shrink-0 flex flex-row items-center justify-center py-[26px] px-[30px] relative gap-[60px] z-[4] text-lg">
              <div className="w-[336.2px] absolute !!m-[0 important] top-[-20.58px] left-[775px] h-[261px] overflow-hidden flex items-center justify-center z-[0]">
                <Image
              ...
              <div className="w-[165.4px] relative shadow-[0px_88px_25px_rgba(0,_0,_0,_0),_0px_56px_23px_rgba(0,_0,_0,_0.03),_0px_32px_19px_rgba(0,_0,_0,_0.1),_0px_14px_14px_rgba(0,_0,_0,_0.17),_0px_4px_8px_rgba(0,_0,_0,_0.2)] h-[50px] z-[2] text-base text-white font-inter">
                <div className="absolute top-[0px] left-[0px] shadow-[0px_0px_8px_4px_rgba(255,_255,_255,_0.16)_inset,_0px_-2px_0px_#000_inset,_0px_1px_1px_#000_inset,_0px_2px_1px_rgba(255,_255,_255,_0.25)_inset] rounded-[20px] [background:linear-gradient(88.67deg,_#1d1d1d,_#333_34.6%,_#3d3d3d_76.69%,_#1d1d1d)] h-[50px] overflow-hidden flex flex-row items-center justify-center py-3 px-6 box-border">
                  <div className="[filter:drop-shadow(0px_2px_2px_rgba(0,_0,_0,_0.48))] flex flex-row items-center justify-start gap-3">
                    <div className="relative tracking-[-0.03em] font-medium">Get Started</div>
                    <Image
              ...
              <Image
                className="w-[336.2px] absolute !!m-[0 important] top-[-21.58px] left-[-107.16px] h-[261px] object-cover z-[3]"
                width={336.2}
                height={261}
                sizes="100vw"
                alt=""
            ...
            <div className="flex-1 flex flex-col items-start justify-start gap-5">
              ...
              <div className="self-stretch rounded-3xl bg-white flex flex-col items-start justify-start p-6 gap-6">
                ...
                <div className="self-stretch relative text-lg tracking-[-0.02em] leading-[150%] text-gray-200">
                  ...
                  dollar count. I highly recommend their services to any business looking to grow!"
                </div>
                <div className="flex flex-row items-center justify-start gap-3 text-base">
                  <Image
                    className="w-[50px] relative rounded-[99px] max-h-full overflow-hidden shrink-0 object-cover"
            ...
            <div className="flex-1 flex flex-col items-start justify-start gap-5">
              <div className="self-stretch rounded-3xl bg-white flex flex-col items-start justify-start p-6 gap-6">
                ...
                <div className="self-stretch relative text-lg tracking-[-0.02em] leading-[150%] text-gray-200">
                  ...
                  months, we achieved a 40% reduction by utilizing their retention strategies. It's
                  been a game-changer for our subscription service."
                </div>
                <div className="flex flex-row items-center justify-start gap-3 text-base">
                  <Image
                    className="w-[50px] relative rounded-[99px] max-h-full overflow-hidden shrink-0 object-cover"
