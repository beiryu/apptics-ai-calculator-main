          ...
          <div className="self-stretch flex flex-col items-center justify-start py-12 px-0 gap-12">
            <div className="self-stretch flex flex-col items-center justify-start relative gap-5">
              ...
              <b className="self-stretch relative text-[28px] tracking-[-0.02em] leading-[110%] font-plus-jakarta-sans z-[1] text-gray-300">
                <span>{`Transform Your eCom Store into a Subscription `}</span>
                <div className="self-stretch flex flex-row items-center justify-center gap-[5px]">
                  <div className="w-[36.1px] relative rounded-[10.67px] h-[36.1px] shrink-0 overflow-hidden flex items-center justify-center">
                    <Image
            ...
            <div className="w-full self-stretch flex flex-col items-start justify-center gap-5 text-left text-gray-300 font-plus-jakarta-sans">
              <div className="w-full shadow-[0px_24px_35px_-12px_rgba(27,_40,_66,_0.05),_0px_3px_1px_rgba(255,_255,_255,_0.25)_inset] rounded-2xl bg-gray-100 border-white border-solid border-[0.8px] overflow-hidden flex flex-col items-start justify-end">
                ...
                <div className="self-stretch overflow-hidden flex flex-col items-start justify-start py-3.5 px-4 text-center font-inter">
                  <div className="self-stretch flex flex-col items-end justify-start gap-2">
                    <div className="self-stretch shadow-[0px_6px_4px_rgba(255,_255,_255,_0.36)_inset,_0px_2px_2px_-1px_rgba(11,_32,_103,_0.05),_0px_0px_30px_-4px_rgba(0,_0,_0,_0.03)] rounded-2xl bg-gray-1600 border-whitesmoke-300 border-solid border-[1px] overflow-hidden flex flex-row items-center justify-start p-3 relative gap-[14.5px]">
                      ...
                      <div className="!!m-[0 important] absolute top-[0px] right-[0px] overflow-hidden flex flex-row items-center justify-center p-3 z-[2] text-xs text-gray-200">
              ...
              <div className="w-full shadow-[0px_24px_35px_-12px_rgba(27,_40,_66,_0.05),_0px_3px_1px_rgba(255,_255,_255,_0.25)_inset] rounded-2xl bg-gray-100 border-white border-solid border-[0.8px] overflow-hidden flex flex-col items-start justify-end">
                <div className="self-stretch overflow-hidden flex flex-col items-start justify-start p-4 gap-1">
                  ...
                  <div className="self-stretch relative text-sm tracking-[-0.02em] leading-[140%] font-inter text-gray-200">
                    Convert more visitors with smart checkouts, built-in upsells, and flexible
                    payment options.
                  </div>
                </div>
                <div className="self-stretch relative h-[265px] overflow-hidden shrink-0 text-[11px] text-darkslategray-100 font-inter">
                  <div className="absolute top-[10px] left-[calc(50%_-_150.33px)] rounded-xl [background:linear-gradient(180deg,_#ebebeb,_rgba(255,_255,_255,_0))] border-white border-solid border-[1px] box-border w-[300px] flex flex-col items-start justify-start p-4 gap-3">
              ...
              <div className="w-full shadow-[0px_24px_35px_-12px_rgba(27,_40,_66,_0.05),_0px_3px_1px_rgba(255,_255,_255,_0.25)_inset] rounded-2xl bg-gray-100 border-white border-solid border-[0.8px] overflow-hidden flex flex-col items-start justify-end text-sm">
                ...
                <div className="self-stretch relative bg-gray-100 h-[297px] overflow-hidden shrink-0 text-center text-[10px] text-gray-200">
                  ...
                  <div className="absolute top-[17px] left-[calc(50%_-_164.67px)] h-[237px] flex flex-row items-end justify-center gap-1.5 text-gray-1300">
                  ...
                  <div className="absolute top-[258.87px] left-[calc(50%_-_160px)] flex flex-row items-center justify-start gap-1">
        ...
        <div className="w-full max-w-[1280px] flex flex-col items-center justify-start py-20 px-0 box-border gap-[60px]">
          <div className="w-full max-w-[1026px] flex flex-col items-center justify-start relative gap-6">
            ...
            <b className="self-stretch relative text-5xl tracking-[-0.02em] leading-[110%] font-plus-jakarta-sans z-[1] text-gray-300">
              ...
              <div className="self-stretch flex flex-row items-center justify-center gap-[5px]">
                <div className="w-[54.2px] relative rounded-[12.32px] h-[54.2px] shrink-0 overflow-hidden flex items-center justify-center">
                  <Image
                    className="w-full h-full overflow-hidden shrink-0 object-cover absolute left-[0px] top-[13px] [transform:scale(1.415)]"
                    width={54.2}
                    height={54.2}
