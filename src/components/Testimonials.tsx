        ...
        <div className="self-stretch flex flex-col items-center justify-start z-[11]">
          <div className="self-stretch overflow-hidden flex flex-col items-center justify-start py-12 px-5 sm:px-10 md:px-20 gap-12">
            <div className="self-stretch flex flex-col items-center justify-start gap-5">
              ...
              <div className="self-stretch flex flex-col items-center justify-start gap-1 text-[28px] text-gray-300 font-plus-jakarta-sans">
                <b className="self-stretch relative tracking-[-0.02em] leading-[110%]">
                ...
                <div className="flex flex-row items-start justify-center gap-1">
                  ...
                  <div className="w-[34.6px] relative rounded-[10.67px] h-[34.6px] shrink-0 overflow-hidden flex items-center justify-center">
                    <Image
                      className="w-full h-full overflow-hidden shrink-0 object-cover absolute left-[0px] top-[18px] [transform:scale(1.875)]"
                      width={34.6}
                      height={34.6}
                      sizes="100vw"
                      alt=""
              ...
              <div className="self-stretch flex flex-col items-start justify-start gap-5">
                <div className="self-stretch rounded-3xl bg-white flex flex-col items-start justify-start p-6 gap-6">
                  ...
                  <div className="self-stretch relative text-lg tracking-[-0.02em] leading-[150%] text-gray-200">
                    &quot;Since implementing Apptics, my customer retention has skyrocketed. The
                    analytics they provide help me understand my customers better, allowing me to
                    tailor my offerings. It&apos;s been a game changer for my business!&quot;
                  </div>
