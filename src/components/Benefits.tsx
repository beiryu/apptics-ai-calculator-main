          ...
          <div className="flex-1 flex flex-col items-center justify-start py-12 px-0 gap-12">
            <div className="self-stretch flex flex-col items-center justify-start relative gap-5">
              ...
              <b className="self-stretch relative text-[28px] tracking-[-0.02em] leading-[110%] font-plus-jakarta-sans z-[1] text-gray-300">
                <p className="m-0 whitespace-pre-wrap">{`Built to Help You   `}</p>
                <p className="m-0">
                  <span>{` `}</span>
              ...
              <div className="w-[34.6px] !!m-[0 important] absolute top-[87px] left-[calc(50%_-_72px)] rounded-[10.67px] h-[34.6px] shrink-0 overflow-hidden flex items-center justify-center z-[3]">
                <Image
            ...
            <div className="self-stretch flex flex-col items-start justify-center gap-5 text-left text-sm text-gray-300">
              <div className="self-stretch flex flex-col items-start justify-start gap-5 text-dimgray">
                <div className="self-stretch rounded-3xl bg-white overflow-hidden shrink-0 flex flex-col items-center justify-end">
                  ...
                  <div className="self-stretch overflow-hidden flex flex-col items-start justify-start pt-0 px-4 pb-4 gap-2 text-base text-gray-300">
                    <div className="self-stretch relative tracking-[-0.01em] leading-[150%] font-semibold">
                      Predictable, Recurring Revenue
                    </div>
                    <div className="self-stretch relative text-sm tracking-[-0.01em] leading-[140%] text-gray-200">
                      Turn one-time buyers into loyal subscribers. we help you to build steady
                ...
                <div className="self-stretch rounded-2xl bg-white h-[460px] overflow-hidden shrink-0 flex flex-col items-center justify-end text-darkslategray-100">
                  <div className="self-stretch flex-1 relative overflow-hidden">
                    ...
                    />
                    {/* Shopping cart overlay - positioned correctly */}
                    <div className="absolute top-[calc(50%_-_130.5px)] left-[calc(50%_-_120px)] shadow-[0px_8px_20px_-8px_rgba(34,_68,_113,_0.25),_0px_12px_14px_-3px_rgba(29,_36,_51,_0.08),_0px_2px_2px_rgba(29,_36,_51,_0.08)] rounded-xl bg-white border-whitesmoke-500 border-solid border-[1px] box-border w-60 overflow-hidden flex flex-col items-start justify-start py-[15px] px-[11px] gap-6 z-10">
                      <div className="self-stretch flex flex-col items-start justify-start gap-4">
                        ...
                        <Image
                          ...
                          sizes="100vw"
                          alt=""
                          src="/assets/features/Vector 1194223266.svg"
                        />
                      </div>
                    ...
                    {/* Vector overlay - positioned correctly on top */}
              ...
              <div className="self-stretch flex flex-col items-start justify-start gap-5">
                <div className="self-stretch rounded-2xl bg-white flex flex-col items-start justify-end text-black">
                  <div
                    className="self-stretch w-full relative overflow-hidden"
                  ...
                  >
                    ...
                    <div className="absolute top-0 left-0 right-0 bottom-0 flex items-center justify-center">
                      <div className="relative w-full max-w-[320px] h-[120px]">
                        ...
                        <div className="absolute bottom-[30%] left-[6%] shadow-[0px_12px_0px_rgba(255,_255,_255,_0.6)_inset] rounded-full [background:linear-gradient(180deg,_#28db89,_#24b271)] w-[4%] h-[35%]"></div>
                        <div className="absolute bottom-[32%] left-[12%] shadow-[0px_12px_0px_rgba(255,_255,_255,_0.6)_inset] rounded-full [background:linear-gradient(180deg,_#28db89,_#24b271)] w-[4%] h-[30%]"></div>
                        <div className="absolute bottom-[20%] left-[18%] shadow-[0px_12px_0px_rgba(255,_255,_255,_0.6)_inset] rounded-full [background:linear-gradient(180deg,_#28db89,_#24b271)] w-[4%] h-[55%]"></div>
                        <div className="absolute bottom-[22%] left-[24%] shadow-[0px_12px_0px_rgba(255,_255,_255,_0.6)_inset] rounded-full [background:linear-gradient(180deg,_#28db89,_#24b271)] w-[4%] h-[60%]"></div>
                        <div className="absolute bottom-[34%] left-[30%] shadow-[0px_12px_0px_rgba(255,_255,_255,_0.6)_inset] rounded-full [background:linear-gradient(180deg,_#28db89,_#24b271)] w-[4%] h-[45%]"></div>
                        <div className="absolute bottom-[30%] left-[36%] shadow-[0px_12px_0px_rgba(255,_255,_255,_0.6)_inset] rounded-full [background:linear-gradient(180deg,_#28db89,_#24b271)] w-[4%] h-[55%]"></div>
                        <div className="absolute bottom-[23%] left-[42%] shadow-[0px_12px_0px_rgba(255,_255,_255,_0.6)_inset] rounded-full [background:linear-gradient(180deg,_#28db89,_#24b271)] w-[4%] h-[45%]"></div>
                        <div className="absolute bottom-[15%] left-[48%] shadow-[0px_12px_0px_rgba(255,_255,_255,_0.6)_inset] rounded-full [background:linear-gradient(180deg,_#28db89,_#24b271)] w-[4%] h-[40%]"></div>
                        <div className="absolute bottom-[7%] left-[54%] shadow-[0px_12px_0px_rgba(255,_255,_255,_0.6)_inset] rounded-full [background:linear-gradient(180deg,_#28db89,_#24b271)] w-[4%] h-[65%]"></div>
                        <div className="absolute bottom-[15%] left-[60%] shadow-[0px_12px_0px_rgba(255,_255,_255,_0.6)_inset] rounded-full [background:linear-gradient(180deg,_#28db89,_#24b271)] w-[4%] h-[65%]"></div>
                        <div className="absolute bottom-[0%] left-[66%] shadow-[0px_12px_0px_rgba(255,_255,_255,_0.6)_inset] rounded-full [background:linear-gradient(180deg,_#28db89,_#24b271)] w-[4%] h-[66%]"></div>
                        <div className="absolute bottom-[15%] left-[72%] shadow-[0px_12px_0px_rgba(255,_255,_255,_0.6)_inset] rounded-full [background:linear-gradient(180deg,_#28db89,_#24b271)] w-[4%] h-[70%]"></div>
                        <div className="absolute bottom-[22%] left-[78%] shadow-[0px_12px_0px_rgba(255,_255,_255,_0.6)_inset] rounded-full [background:linear-gradient(180deg,_#28db89,_#24b271)] w-[4%] h-[50%]"></div>
                        <div className="absolute bottom-[32%] left-[84%] shadow-[0px_12px_0px_rgba(255,_255,_255,_0.6)_inset] rounded-full [background:linear-gradient(180deg,_#28db89,_#24b271)] w-[4%] h-[25%]"></div>
                        <div className="absolute bottom-[30%] left-[90%] shadow-[0px_12px_0px_rgba(255,_255,_255,_0.6)_inset] rounded-full [background:linear-gradient(180deg,_#28db89,_#24b271)] w-[4%] h-[35%]"></div>
                      </div>
                    </div>
                    {/* Live badge - positioned responsively */}
                    <div className="absolute top-4 left-4 rounded-xl border-whitesmoke-800 border-solid border-[1px] overflow-hidden flex flex-row items-center justify-start py-2 px-3 gap-2">
                      ...
                      <div className="relative tracking-[-0.01em] text-sm">Live</div>
                    </div>
                  </div>
                  <div className="self-stretch flex flex-col items-start justify-start pt-0 px-4 pb-4 gap-2 text-base text-gray-300">
                    <div className="self-stretch relative tracking-[-0.01em] leading-[150%] font-semibold">
                ...
                <div className="self-stretch rounded-3xl bg-white overflow-hidden shrink-0 flex flex-col items-center justify-end">
                  ...
                  <div className="self-stretch flex flex-col items-start justify-start pt-0 px-4 pb-4 gap-2">
                    <div className="self-stretch relative tracking-[-0.01em] leading-[150%] font-semibold">
                      Less Busywork, More Growth
                    </div>
                    <div className="self-stretch relative text-sm tracking-[-0.01em] leading-[140%] text-gray-200">
                      We automate billing, renewals, and decline recovery so you can focus on
                      scaling
                    </div>
                  </div>
                </div>
              ...
              <div className="self-stretch flex flex-col items-end justify-start gap-5 text-xs">
                <div className="self-stretch rounded-2xl bg-white overflow-hidden shrink-0 flex flex-col items-center justify-end">
                  <div className="self-stretch aspect-square w-full relative overflow-hidden">
                    <Lottie
                  ...
                  <div className="self-stretch overflow-hidden flex flex-col items-start justify-start pt-0 px-4 pb-4 gap-2 text-base">
                    <div className="self-stretch relative tracking-[-0.01em] leading-[150%] font-semibold">
                ...
                <div className="self-stretch relative rounded-3xl bg-white overflow-hidden shrink-0 text-xl">
                  <div className="absolute bottom-[0px] left-[0px] w-full flex flex-col items-start justify-start p-4 box-border gap-4">
                    <div className="self-stretch relative tracking-[-0.02em] leading-[130%] capitalize font-semibold">
                      Enhance Profits from your Shopify via Memberships
                    </div>
                    <div className="self-stretch relative text-sm tracking-[-0.01em] leading-[140%] text-gray-200 whitespace-pre-wrap">{`Our platform is built for highly driven and focused entrepreneurs who want to achieve conversion &  retention rates which will shoot their profits to the moon.`}</div>
                    <div className="w-[191px] relative shadow-[0px_14px_14px_rgba(0,_0,_0,_0.17),_0px_4px_8px_rgba(0,_0,_0,_0.2)] h-[50px] text-base text-white">
                  ...
                  >
                    ...
                    <div className="absolute top-0 left-0 right-0 bottom-0 flex items-center justify-center">
                      <div className="relative w-full max-w-[400px] h-[140px]">
                        {/* Chart bars - responsive sizing */}
                        {/* <div className="absolute bottom-0 left-[0%] shadow-[0px_12px_0px_rgba(255,_255,_255,_0.6)_inset] rounded-full [background:linear-gradient(180deg,_#28db89,_#24b271)] w-[3%] h-[40%]"></div> */}
                        <div className="absolute bottom-[30%] left-[6%] shadow-[0px_12px_0px_rgba(255,_255,_255,_0.6)_inset] rounded-full [background:linear-gradient(180deg,_#28db89,_#24b271)] w-[4%] h-[35%]"></div>
                        <div className="absolute bottom-[32%] left-[12%] shadow-[0px_12px_0px_rgba(255,_255,_255,_0.6)_inset] rounded-full [background:linear-gradient(180deg,_#28db89,_#24b271)] w-[4%] h-[30%]"></div>
                        <div className="absolute bottom-[20%] left-[18%] shadow-[0px_12px_0px_rgba(255,_255,_255,_0.6)_inset] rounded-full [background:linear-gradient(180deg,_#28db89,_#24b271)] w-[4%] h-[55%]"></div>
                        <div className="absolute bottom-[22%] left-[24%] shadow-[0px_12px_0px_rgba(255,_255,_255,_0.6)_inset] rounded-full [background:linear-gradient(180deg,_#28db89,_#24b271)] w-[4%] h-[60%]"></div>
                        ...
                        <div className="absolute bottom-[32%] left-[84%] shadow-[0px_12px_0px_rgba(255,_255,_255,_0.6)_inset] rounded-full [background:linear-gradient(180deg,_#28db89,_#24b271)] w-[4%] h-[25%]"></div>
                        <div className="absolute bottom-[30%] left-[90%] shadow-[0px_12px_0px_rgba(255,_255,_255,_0.6)_inset] rounded-full [background:linear-gradient(180deg,_#28db89,_#24b271)] w-[4%] h-[35%]"></div>
                        {/* <div className="absolute bottom-0 left-[96%] shadow-[0px_12px_0px_rgba(255,_255,_255,_0.6)_inset] rounded-full [background:linear-gradient(180deg,_#28db89,_#24b271)] w-[3%] h-[52%]"></div> */}
                      </div>
                    </div>
                    {/* Live badge - positioned responsively */}
                    <div className="absolute top-5 left-5 rounded-xl border-whitesmoke-800 border-solid border-[1px] overflow-hidden flex flex-row items-center justify-start py-2 px-3 gap-2">
                      <div className="w-[7.4px] relative h-[7.4px] overflow-hidden flex items-center justify-center">
                        <Image
                          className="w-full h-full object-cover absolute left-[0px] top-[0px] [transform:scale(2.624)]"
                          width={7.4}
