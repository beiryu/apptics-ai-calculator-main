...
import { className as className3, css as css3, fonts as fonts3 } from "../chunks/chunk-2DPBRKJY.js";
  ...
  "../../../node_modules/dataloader/index.js"(t32, e42) {
      ...
      n2 = /* @__PURE__ */ (function () {
          ...
          ((this._batchLoadFn = t5),
            ...
            (this._cacheMap = (function (t6) {
              ...
              if (null !== e7) {
                ...
                if (0 !== r3.length)
                  throw TypeError("Custom cacheMap missing methods: " + r3.join(", "));
              }
              return e7;
            })(e6)),
            (this._batch = null),
        ...
        return (
          (e5.load = function (t5) {
            ...
            var e6 = (function (t6) {
                var e7 = t6._batch;
                if (null !== e7 && !e7.hasDispatched && e7.keys.length < t6._maxBatchSize)
                  return e7;
                var r4 = {
                  hasDispatched: false,
                  keys: [],
          ...
          (e5.loadMany = function (t5) {
            if (!o22(t5))
              throw TypeError(
                "The loader.loadMany() function must be called with Array<key> but got: " + t5 + "."
              );
    ...
    function o22(t4) {
      return (
        ...
        (0 === t4.length ||
          (t4.length > 0 && Object.prototype.hasOwnProperty.call(t4, t4.length - 1)))
      );
    }
    e42.exports = n2;
  },
...
function _(e42, r22) {
  for (let n2 of (e42.writeUint16(r22.value.length), r22.value)) t.write(e42, n2);
}
...
function ty(t32, e42) {
  let r22 = t32.value,
    n2 = e42.value;
  if ((N(r22) && N(n2)) || (x(r22) && x(n2))) return r22 < n2 ? -1 : r22 > n2 ? 1 : 0;
  throw Error("Invalid rich text pointer");
}
function tp(t32) {
  return {
...
function tm(t32, e42, r22) {
  let n2 = t32.value,
    i22 = e42.value;
  return (0 === r22.type && ((n2 = t32.value.toLowerCase()), (i22 = e42.value.toLowerCase())),
  n2 < i22)
    ? -1
    : n2 > i22
      ? 1
...
async function tM(t32, e42) {
  let r22 = tx(e42),
    n2 = [],
    i22 = 0;
  for (let t4 of r22) (n2.push(`${t4.from}-${t4.to - 1}`), (i22 += t4.to - t4.from));
  let s2 = new URL(t32),
    a2 = n2.join(",");
      ...
      <Variants animate={variants} initial={false}>
        <Transition value={transition1}>
          <motion.div
            {...restProps}
            {...gestureHandlers}
            className={cx(scopingClassNames, "framer-1rpirs3", className5, classNames)}
            data-border={true}
            data-framer-name={"XL"}
...
var FrameraIpS8Xf7M = withCSS(Component, css5, "framer-VuUsg");
      ...
      <Variants2 animate={variants} initial={false}>
        <Transition2 value={transition12}>
          <motion2.div
            {...restProps}
            {...gestureHandlers}
            className={cx2(scopingClassNames, "framer-h2r8cl", className5, classNames)}
...
var Transition3 = ({ value, children }) => {
  ...
  return (
    <MotionConfigContext3.Provider value={contextValue}>{children}</MotionConfigContext3.Provider>
  );
};
...
var getProps3 = ({ height, id, radius, width, ...props }) => {
  return {
    ...
    variant: humanReadableVariantMap2[props.variant] ?? props.variant ?? "VtQ4tqlHA",
  };
};
      ...
      <Variants3 animate={variants} initial={false}>
        <Transition3 value={transition13}>
          <motion3.div
            {...restProps}
            {...gestureHandlers}
            className={cx3(scopingClassNames, "framer-1su0bac", className5, classNames)}
            data-framer-name={"Features"}
            layoutDependency={layoutDependency}
            layoutId={"VtQ4tqlHA"}
            ref={refBinding}
          ...
          >
            <Image2
              background={{
                alt: "",
                fit: "fill",
                loading: getLoadingLazyAtYPosition2((componentViewport?.y || 0) + 0),
                pixelHeight: 97,
                pixelWidth: 97,
...
var Transition4 = ({ value, children }) => {
  ...
  return (
    <MotionConfigContext4.Provider value={contextValue}>{children}</MotionConfigContext4.Provider>
  );
};
...
var getProps4 = ({ height, id, width, ...props }) => {
  return {
    ...props,
    variant: humanReadableVariantMap3[props.variant] ?? props.variant ?? "YvISmlXEt",
  };
};
      ...
      <Variants4 animate={variants} initial={false}>
        <Transition4 value={transition14}>
          <motion4.div
            {...restProps}
            {...gestureHandlers}
            className={cx4(scopingClassNames, "framer-1rg56x7", className5, classNames)}
              ...
              >
                ...
                >
                  <RichText3
                    ...
                    data-framer-name={"Transform Your eCom Store into a Subscription Powerhouse"}
                    fonts={["Inter"]}
                    layoutDependency={layoutDependency}
                    layoutId={"C4hMU_CVl"}
                    style={{
                  ...
                  <ComponentViewportProvider
                    height={48}
                    width={"48px"}
                    y={(componentViewport?.y || 0) + 0 + 0 + 80 + 0 + 0 + 64 + 6}
                    {...addPropertyOverrides4(
                      {
                        UllKRJK36: {
                          y: (componentViewport?.y || 0) + 0 + 0 + 60 + 0 + 0 + 64 + 6,
                        },
                      },
                      baseVariant,
                      gestureVariant
                ...
                <RichText3
                  ...
                  data-framer-name={"Get up and running quickly with a guide, hassle free setup"}
                  fonts={["Inter"]}
                  layoutDependency={layoutDependency}
                  layoutId={"AinPt6M_H"}
                  style={{
                          ...
                          <_Fragment>
                            {collection?.map(
                              (
                                ...
                                ogLD0BJbWkZr11Y59r2 ??= "";
                                return (
                                  <LayoutGroup4 id={`kZr11Y59r-${idkZr11Y59r2}`}>
                                      ...
                                      >
                                        ...
                                        >
                                          {_jsx4(stdin_default3, {
                                            height: "100%",
                                            id: "IJRw1BNtp",
                                            k3Tl3nY69: toResponsiveImage2(Hp8kpqqOLkZr11Y59r2),
                                            layoutId: "IJRw1BNtp",
                            ...
                            <_Fragment>
                              {collection1?.map(
                                (
                                  ...
                                  ogLD0BJbWRylXxmXCl2 ??= "";
                                  return (
                                    <LayoutGroup4 id={`RylXxmXCl-${idRylXxmXCl2}`}>
                                      <PathVariablesContext.Provider
                                        value={{
                                          ogLD0BJbW: ogLD0BJbWRylXxmXCl2,
                                        }}
                                      >
                                        ...
                                        >
                                          <SmartComponentScopedContainerWithFX
                                            ...
                                            __smartComponentFX={true}
                                            __targetOpacity={1}
                                            className={"framer-kyb8oe-container"}
                                            layoutDependency={layoutDependency}
                                          ...
                                          >
                                            {_jsx4(stdin_default3, {
                                              height: "100%",
                                              id: "uvNAQbLCW",
                                              k3Tl3nY69: toResponsiveImage2(Hp8kpqqOLRylXxmXCl2),
                                              layoutId: "uvNAQbLCW",
