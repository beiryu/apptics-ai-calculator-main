          ...
          <div className="self-stretch rounded-[32px] bg-white flex flex-col items-center justify-start py-12 px-5 sm:px-10 md:px-32 gap-12">
            ...
            <div className="self-stretch flex flex-col items-start justify-start gap-12 lg:gap-5 text-left text-lg text-gray-300">
              <motion.div
                ...
                className="self-stretch shadow-[0px_0px_24px_4px_rgba(255,_255,_255,_0.8)_inset] rounded-3xl bg-white border-gainsboro-600 border-solid border-[1px] flex flex-col items-center justify-start py-10 px-0 relative gap-[60px]"
              >
              ...
              <motion.div
                ...
                viewport={{ once: true, amount: 0.5 }}
                variants={scrollAnimation2Variants}
                className="self-stretch shadow-[0px_0px_24px_4px_rgba(255,_255,_255,_0.8)_inset] rounded-3xl bg-white border-gainsboro-600 border-solid border-[1px] flex flex-col items-center justify-start py-10 px-0 relative gap-[60px] font-plus-jakarta-sans"
              >
                ...
                <Link
                  ...
                  target="_blank"
                  className="self-stretch flex flex-col items-start justify-start py-0 px-8 z-[2] text-white"
                >
                  <div className="self-stretch cursor-pointer hover:shadow-none transition-all duration-300 shadow-[0px_47px_13px_rgba(6,_16,_55,_0),_0px_30px_12px_rgba(6,_16,_55,_0.03),_0px_17px_10px_rgba(6,_16,_55,_0.12),_0px_8px_8px_rgba(6,_16,_55,_0.2),_0px_2px_4px_rgba(6,_16,_55,_0.23)] rounded-[20px] bg-mediumslateblue-200 flex flex-col items-start justify-start p-0.5">
              ...
              <div className="self-stretch shadow-[0px_0px_24px_4px_rgba(255,_255,_255,_0.8)_inset] rounded-3xl bg-white border-gainsboro-600 border-solid border-[1px] flex flex-col items-center justify-start py-10 px-0 relative gap-[60px]">
                ...
                <div className="self-stretch flex flex-col items-start justify-start py-0 px-8 gap-2 z-[2] text-5xl">
                  <Link
                    href="https://cal.com/akash-fmj/30min"
                    target="_blank"
                    className="self-stretch rounded-full hover:shadow-none transition-all duration-300 shadow-[0px_47px_13px_rgba(6,_16,_55,_0),_0px_30px_12px_rgba(6,_16,_55,_0.03),_0px_17px_10px_rgba(6,_16,_55,_0.12),_0px_8px_8px_rgba(6,_16,_55,_0.2),_0px_2px_4px_rgba(6,_16,_55,_0.23)] flex flex-col items-center justify-start gap-6"
                  >
          ...
          <div className="self-stretch rounded-[60px] bg-white flex flex-col items-center justify-start py-[60px] px-0 gap-[60px]">
            ...
            <div className="w-full max-w-[1280px] flex flex-row items-start justify-center gap-10 text-left text-lg text-gray-300 font-plus-jakarta-sans">
              <motion.div
                ...
                viewport={{ once: true, amount: 0.5 }}
                variants={scrollAnimation2Variants}
                className="w-full max-w-[420px] shadow-[0px_0px_24px_4px_rgba(255,_255,_255,_0.8)_inset] rounded-3xl bg-white border-gainsboro-600 border-solid border-[1px] box-border flex flex-col items-center justify-start py-10 px-0 relative gap-[60px]"
              >
                <div className="absolute !!m-[0 important] top-[0px] left-[0px] w-full rounded-3xl h-[723px] overflow-hidden shrink-0 z-[0]">
                  <div className="absolute top-[0px] left-[0px] w-full h-full overflow-hidden flex items-center justify-center">
                    <Image
                ...
                <Link
                  href="https://cal.com/akash-fmj/30min"
                  target="_blank"
                  className="cursor-pointer self-stretch flex flex-col items-start justify-start py-0 px-8 z-[2] text-white"
                >
                  <div className="self-stretch hover:shadow-none transition-all duration-300 shadow-[0px_47px_13px_rgba(6,_16,_55,_0),_0px_30px_12px_rgba(6,_16,_55,_0.03),_0px_17px_10px_rgba(6,_16,_55,_0.12),_0px_8px_8px_rgba(6,_16,_55,_0.2),_0px_2px_4px_rgba(6,_16,_55,_0.23)] rounded-[20px] bg-mediumslateblue-200 flex flex-col items-start justify-start p-0.5">
                    <div className="self-stretch shadow-[0px_0px_10px_2px_rgba(255,_255,_255,_0.25)_inset,_0px_1px_0px_rgba(255,_255,_255,_0.25)_inset,_0px_-1px_0px_rgba(255,_255,_255,_0.25)_inset,_0px_3px_0px_rgba(255,_255,_255,_0.1)_inset,_0px_-3px_0px_rgba(255,_255,_255,_0.1)_inset,_0px_1.028807520866394px_0px_rgba(203,_203,_203,_0.15)] rounded-[18px] bg-mediumslateblue-100 overflow-hidden flex flex-row items-center justify-center p-2 relative gap-2">
                      {/* <Image
                      className="w-[222.9px] absolute !!m-[0 important] top-[-33.19px] left-[calc(50%_-_111.78px)] h-[46.6px] hidden opacity-[0.3] [mix-blend-mode:linear-dodge] z-[0]"
                      width={222.9}
              ...
              <motion.div
                ...
                viewport={{ once: true, amount: 0.5 }}
                variants={scrollAnimation2Variants}
                className="w-[420px] shadow-[0px_0px_24px_4px_rgba(255,_255,_255,_0.8)_inset] rounded-3xl bg-white border-gainsboro-600 border-solid border-[1px] box-border overflow-hidden shrink-0 flex flex-col items-center justify-start py-10 px-0 relative gap-[60px] font-inter"
              >
                <div className="absolute !!m-[0 important] top-[0px] left-[0px] w-full rounded-3xl h-[723px] overflow-hidden shrink-0 z-[0]">
                  {/* <Image
                ...
                <div className="self-stretch flex flex-col items-start justify-start py-0 px-8 gap-2 z-[2] text-5xl">
                  <Link
                    href="https://cal.com/akash-fmj/30min"
                    target="_blank"
                    className="self-stretch rounded-full cursor-pointer hover:shadow-none transition-all duration-300 shadow-[0px_47px_13px_rgba(6,_16,_55,_0),_0px_30px_12px_rgba(6,_16,_55,_0.03),_0px_17px_10px_rgba(6,_16,_55,_0.12),_0px_8px_8px_rgba(6,_16,_55,_0.2),_0px_2px_4px_rgba(6,_16,_55,_0.23)] flex flex-col items-center justify-start gap-6"
                  >
                    <div className="w-[346.7px] hidden flex-col items-center justify-start gap-1">
                      <div className="relative tracking-[-0.03em] leading-[120%] font-semibold">
                        $3999
