...
const Pricing = () => {
        ...
        <div className="self-stretch flex flex-col items-center justify-start py-10 px-0 z-[9]">
          <div className="self-stretch rounded-[32px] bg-white flex flex-col items-center justify-start py-12 px-5 sm:px-10 md:px-32 gap-12">
            <div className="self-stretch flex flex-col items-center justify-start relative gap-5">
              ...
              <b className="self-stretch relative text-[28px] tracking-[-0.02em] leading-[110%] font-plus-jakarta-sans z-[1] text-gray-300 flex flex-row items-center justify-center">
                <span className="whitespace-nowrap">Fair Pricing</span>
                <div className="w-[34.1px] relative rounded-[10.67px] h-[34.1px] shrink-0 overflow-hidden flex items-center justify-center mx-1">
                  <Image
                    className="w-full h-full overflow-hidden shrink-0 object-cover absolute left-[0px] top-[18px] [transform:scale(1.897)]"
                    width={34.1}
                    height={34.1}
                    sizes="100vw"
                    alt=""
                ...
                <span className="whitespace-nowrap text-transparent !bg-clip-text [background:linear-gradient(90deg,_#12b2f9,_#514dfa)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent]">
                  No Surprises
                </span>
              </b>
            ...
            <div className="self-stretch flex flex-col items-start justify-start gap-12 lg:gap-5 text-left text-lg text-gray-300">
              <div className="self-stretch shadow-[0px_0px_24px_4px_rgba(255,_255,_255,_0.8)_inset] rounded-3xl bg-white border-gainsboro-600 border-solid border-[1px] flex flex-col items-center justify-start py-10 px-0 relative gap-[60px]">
                <div className="absolute !!m-[0 important] top-[-0.1px] left-[0px] w-full rounded-3xl h-[723px] overflow-hidden shrink-0 z-[0]">
                  <div className="absolute top-[-270.73px] left-[-123.88px] w-[200%] h-[409.8px] overflow-hidden flex items-center justify-center">
                    <Image
                      className="w-full h-full object-cover absolute left-[0px] top-[50px] [transform:scale(1)]"
                      width={800}
                      height={409.8}
                      sizes="100vw"
                      alt=""
                ...
                <div className="self-stretch flex flex-col items-start justify-start gap-8 z-[1]">
                  <div className="self-stretch h-[180px] flex flex-col items-start justify-start py-0 px-2 box-border">
                    <div className="self-stretch shadow-[0px_1px_2px_rgba(255,_255,_255,_0.8)_inset] [backdrop-filter:blur(8px)] rounded-t-3xl rounded-b-none [background:linear-gradient(180deg,_rgba(255,_255,_255,_0.3),_#fff)] flex flex-col items-start justify-start pt-6 px-5 pb-0 gap-5">
                      <div className="self-stretch flex flex-row items-center justify-center gap-2.5">
                        <div className="w-[26px] relative h-[26px] flex items-center justify-center">
                          <Image
                            className="w-full object-cover absolute left-[0px] top-[12px] h-full [transform:scale(2.128)]"
                            width={26}
                            height={26}
                            sizes="100vw"
                            alt=""
                            src="/assets/pricing/shining-2.svg"
                          />
                        </div>
                        <div className="flex-1 relative tracking-[-0.04em] leading-[150%] uppercase font-semibold">
                          30-day free trial
                        </div>
                      </div>
                      <div className="self-stretch relative text-sm tracking-[-0.02em] leading-[150%] text-gray-200">
                        Unlock your full potential with Stay AI—try all our tools and features
                  ...
                  <div className="w-[413.3px] overflow-hidden flex flex-col items-start justify-start py-0 px-7 box-border gap-5 text-base text-gray-200">
                    <div className="self-stretch flex flex-row items-center justify-center gap-3">
                      <div className="w-[22px] relative shadow-[0px_9px_6px_-2px_rgba(21,_24,_72,_0.12),_0px_2px_2px_rgba(21,_24,_72,_0.08),_0px_2px_2px_rgba(255,_255,_255,_0.2)_inset,_0px_1px_2px_rgba(255,_255,_255,_0.25)_inset] rounded-[99px] [background:linear-gradient(225.01deg,_#474747,_#000)] h-[22px] overflow-hidden shrink-0 flex items-center justify-center">
                        <div className="[filter:drop-shadow(0px_1px_1px_#fff_inset)_drop-shadow(0px_2px_1.5px_rgba(0,_0,_0,_0.16))] w-3.5 h-3.5 flex items-center justify-center">
                          <Image
                ...
                <div className="self-stretch flex flex-col items-start justify-start py-0 px-8 z-[2] text-center text-white font-plus-jakarta-sans">
                  <div className="self-stretch rounded-full shadow-[0px_47px_13px_rgba(6,_16,_55,_0),_0px_30px_12px_rgba(6,_16,_55,_0.03),_0px_17px_10px_rgba(6,_16,_55,_0.12),_0px_8px_8px_rgba(6,_16,_55,_0.2),_0px_2px_4px_rgba(6,_16,_55,_0.23)] h-[52px] flex flex-col items-center justify-start">
                    <div className="self-stretch shadow-[0px_0px_8px_4px_rgba(255,_255,_255,_0.16)_inset,_0px_-2px_0px_#000_inset,_0px_1px_1px_#000_inset,_0px_2px_1px_rgba(255,_255,_255,_0.25)_inset] rounded-[20px] [background:linear-gradient(88.67deg,_#1d1d1d,_#333_34.6%,_#3d3d3d_76.69%,_#1d1d1d)] h-[52px] flex flex-row items-center justify-center p-2 box-border gap-3">
                      <div className="hidden flex-row items-center justify-start gap-[5.8px]">
                        <Image
                          ...
                          sizes="100vw"
                          alt=""
                          src="/assets/pricing/Frame 2147228244.png"
                        />
                      ...
                      <div className="flex-1 overflow-hidden flex flex-row items-center justify-center">
                        <div className="flex-1 relative tracking-[-0.03em] font-medium">
                          Try for Free
                        </div>
                      </div>
                    </div>
              ...
              <div className="self-stretch shadow-[0px_0px_24px_4px_rgba(255,_255,_255,_0.8)_inset] rounded-3xl bg-white border-gainsboro-600 border-solid border-[1px] flex flex-col items-center justify-start py-10 px-0 relative gap-[60px] font-plus-jakarta-sans">
                <div className="absolute !!m-[0 important] top-[0px] left-[0px] w-full rounded-3xl h-[723px] overflow-hidden shrink-0 z-[0]">
                  <div className="absolute top-[0px] left-[0px] w-full h-full overflow-hidden flex items-center justify-center">
                    <Image
                      className="w-full h-full object-cover absolute left-[0px] top-[-20px]"
                      width={800}
                      height={723}
                      sizes="100vw"
                      alt=""
                      src="/assets/pricing/Frame 2147228256 (1).svg"
                    />
                  </div>
                </div>
                ...
                <div className="!!m-[0 important] absolute top-[-17px] right-[23.67px] shadow-[0px_10px_24px_rgba(0,_0,_0,_0.1),_0px_1px_2px_rgba(0,_0,_0,_0.08),_0px_3px_5px_-4px_rgba(0,_0,_0,_0.08)] rounded-[99px] bg-white border-whitesmoke-600 border-solid border-[0.5px] flex flex-row items-center justify-center py-2 px-4 gap-2 z-[10] text-sm">
                  <div className="w-7 relative h-[18px] flex items-center justify-center z-[11]">
                    <Image
                      className="absolute top-[0px] left-[0px] [transform:scale(1.199)]"
                      width={28}
                      height={18}
                      sizes="100vw"
                      alt=""
                  ...
                  <div className="relative tracking-[-0.03em] leading-[150%] font-semibold text-transparent !bg-clip-text [background:linear-gradient(90deg,_#12b2f9,_#514dfa)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent] [text-shadow:0px_1px_2px_rgba(0,_0,_0,_0.08)] z-[11]">
                    Client Choice
                  </div>
                </div>
              </div>
              <div className="self-stretch shadow-[0px_0px_24px_4px_rgba(255,_255,_255,_0.8)_inset] rounded-3xl bg-white border-gainsboro-600 border-solid border-[1px] flex flex-col items-center justify-start py-10 px-0 relative gap-[60px]">
                <div className="absolute !!m-[0 important] top-[0px] left-[0px] w-full rounded-3xl h-[723px] overflow-hidden shrink-0 z-[0]">
                  <div className="absolute top-[0px] left-[0px] w-full h-full overflow-hidden flex items-center justify-center">
                    <Image
                      className="w-full h-full object-cover absolute left-[0px] top-[0px]"
                      width={800}
                      height={723}
                      sizes="100vw"
                      alt=""
                      src="/assets/pricing/Frame 2147228256.svg"
                    />
                  </div>
                </div>
                <div className="self-stretch flex flex-col items-start justify-start gap-8 z-[1]">
                ...
                <div className="self-stretch flex flex-col items-start justify-start py-0 px-8 gap-2 z-[2] text-5xl">
                  <div className="self-stretch rounded-full shadow-[0px_47px_13px_rgba(6,_16,_55,_0),_0px_30px_12px_rgba(6,_16,_55,_0.03),_0px_17px_10px_rgba(6,_16,_55,_0.12),_0px_8px_8px_rgba(6,_16,_55,_0.2),_0px_2px_4px_rgba(6,_16,_55,_0.23)] flex flex-col items-center justify-start gap-6">
  ...
  //     <>
  //       <div className="self-stretch flex flex-col items-center justify-start py-10 px-0 z-[9]">
  //         <div className="self-stretch rounded-[45px] bg-white flex flex-col items-center justify-start py-[40px] px-0 gap-[40px]">
  //           <div className="w-full max-w-[700px] flex flex-col items-center justify-start relative gap-6">
  //             <div className="shadow-[0px_8px_8px_-4px_rgba(0,_0,_0,_0.12),_0px_3px_2px_-1px_rgba(0,_0,_0,_0.08)] rounded-[99px] bg-white border-gainsboro-400 border-solid border-[1px] overflow-hidden flex flex-row items-center justify-center py-2 px-4 z-[0]">
  //               <div className="relative tracking-[-0.04em] leading-[130%]">Pricing</div>
  //             </div>
  //             <b className="self-stretch relative text-4xl tracking-[-0.02em] leading-[110%] font-plus-jakarta-sans z-[1] text-gray-300 text-center">
  //               <span className="whitespace-pre-wrap">{`Fair Pricing         `}</span>
  //               <span className="text-transparent !bg-clip-text [background:linear-gradient(90deg,_#12b2f9,_#514dfa)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent]">
  //                 No Surprises
  //               </span>
  //             </b>
  //             <div className="w-full relative text-base tracking-[-0.04em] leading-[150%] text-gray-200 inline-block z-[2] text-center">
  //               Sick of payment issues, billing errors, and chargebacks? We handle all the backend
  //               work payments, disputes, data, and retention.
  //             </div>
  //             <div className="w-[45px] absolute !!m-[0 important] top-[calc(50%_-_29.89px)] left-[calc(50%_-_38.58px)] rounded-2xl h-[45px] shrink-0 overflow-hidden flex items-center justify-center z-[3]">
  //               <Image
  //                 className="w-full h-full overflow-hidden shrink-0 object-cover absolute left-[0px] top-[26px] [transform:scale(1.896)]"
  //                 width={45}
  //                 height={45}
  ...
  //             </div>
  //           </div>
  //           <div className="w-full flex flex-col items-center justify-center gap-8 text-left text-lg text-gray-300 font-plus-jakarta-sans">
  //             {/* Адаптированное отображение карточек для планшета - вертикальное, но с большими размерами */}
  //             <div className="w-full max-w-[600px] shadow-[0px_0px_24px_4px_rgba(255,_255,_255,_0.8)_inset] rounded-3xl bg-white border-gainsboro-600 border-solid border-[1px] box-border flex flex-col items-center justify-start py-10 px-0 relative gap-[40px]">
  //               <div className="w-full absolute !!m-[0 important] top-[0px] left-[0px] rounded-3xl h-[723px] overflow-hidden shrink-0 z-[0]">
  //                 <div className="absolute top-[0px] left-[0px] w-full h-full overflow-hidden flex items-center justify-center">
  //                   <Image
  //                     className="w-full h-full object-contain absolute left-[0px] top-[-20px]"
  //                     width={600}
  //                     height={723}
  //                     sizes="100vw"
  //                     alt=""
  ...
  //               </div>
  //               <div className="self-stretch flex flex-col items-start justify-start gap-8 z-[1] font-inter">
  //                 <div className="self-stretch h-[180px] flex flex-col items-start justify-start py-0 px-4 box-border">
  //                   <div className="self-stretch shadow-[0px_1px_2px_rgba(255,_255,_255,_0.8)_inset] [backdrop-filter:blur(8px)] rounded-t-3xl rounded-b-none [background:linear-gradient(180deg,_rgba(255,_255,_255,_0.3),_#fff)] flex flex-col items-start justify-start pt-6 px-5 pb-0 gap-5">
  //                     <div className="self-stretch flex flex-row items-center justify-center gap-2">
  //                       <div className="w-[26px] relative h-[26px] flex items-center justify-center">
  //                         <Image
  ...
  //               </div>
  //             </div>
  //             <div className="w-full max-w-[600px] shadow-[0px_0px_24px_4px_rgba(255,_255,_255,_0.8)_inset] rounded-3xl bg-white border-gainsboro-600 border-solid border-[1px] box-border overflow-hidden shrink-0 flex flex-col items-center justify-start py-10 px-0 relative gap-[40px] font-inter">
  //               <div className="w-full absolute !!m-[0 important] top-[0px] left-[0px] rounded-3xl h-[723px] overflow-hidden shrink-0 z-[0]">
  //                 <div className="absolute top-[0px] left-[0px] w-full h-full overflow-hidden flex items-center justify-center">
  //                   <Image
  //                     className="w-full h-full object-contain absolute left-[0px] top-[0px]"
  //                     width={600}
  //                     height={723}
  //                     sizes="100vw"
  //                     alt=""
  ...
  //               </div>
  //               <div className="flex flex-col items-start justify-start gap-8 z-[1]">
  //                 <div className="w-[95%] h-[180px] flex flex-col items-start justify-start py-0 px-2 box-border">
  //                   <div className="self-stretch shadow-[0px_1px_2px_rgba(255,_255,_255,_0.8)_inset] [backdrop-filter:blur(8px)] rounded-t-3xl rounded-b-none [background:linear-gradient(180deg,_rgba(255,_255,_255,_0.3),_#fff)] flex flex-col items-start justify-start pt-6 px-5 pb-0 gap-5">
  //                     <div className="self-stretch flex flex-row items-center justify-center gap-2.5">
  //                       <div className="w-[26px] relative h-[26px] flex items-center justify-center">
  //                         <Image
  ...
  //                   </div>
  //                 </div>
  //                 <div className="w-[95%] relative border-lightgray border-solid border-t-[1px] box-border h-px" />
  //                 <div className="self-stretch overflow-hidden flex flex-col items-start justify-start py-0 px-7 gap-5 text-base text-gray-200">
  //                   <div className="self-stretch flex flex-row items-center justify-center gap-3">
  //                     <div className="w-[22px] relative shadow-[0px_9px_6px_-2px_rgba(21,_24,_72,_0.12),_0px_2px_2px_rgba(21,_24,_72,_0.08),_0px_2px_2px_rgba(255,_255,_255,_0.2)_inset,_0px_1px_2px_rgba(255,_255,_255,_0.25)_inset] rounded-[99px] [background:linear-gradient(225.01deg,_#474747,_#000)] h-[22px] overflow-hidden shrink-0 flex items-center justify-center">
  //                       <div className="[filter:drop-shadow(0px_1px_1px_#fff_inset)_drop-shadow(0px_2px_1.5px_rgba(0,_0,_0,_0.16))] w-3.5 h-3.5 flex items-center justify-center">
